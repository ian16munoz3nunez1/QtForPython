...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menubar.setGeometry(QRect(0, 0, 303, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", u"Movimiento de una part\u00edcula", None))
